...
//                throw NSError(domain: "", code: -1, userInfo: [NSLocalizedDescriptionKey: "clientId is mandatory"])
//            }
//            guard let clientSecret = clientSecret, !clientSecret.isEmpty else {
//                throw NSError(domain: "", code: -1, userInfo: [NSLocalizedDescriptionKey: "clientSecret is mandatory"])
//            }
            return Options(
                clientId: clientId ?? "",
